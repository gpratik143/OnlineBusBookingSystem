...
label1.pack(pady=10)
Label(root,text="Name: Pratik Gupta",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Er : 221B276",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Mobile: 9340633138",fg='blue',font=('Helvetica',15)).pack(pady=10)
